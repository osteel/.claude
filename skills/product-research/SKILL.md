...
description: Generate a research prompt for any UX, product, or feature design question.
disable-model-invocation: true
---

# Product Research Prompt Generator
...
| Navigation components (sidebar, header, tabs) | Information architecture — how features are organised |
...
Please provide your findings organised as:
...
Depending on the topic provided in `$ARGUMENTS`, emphasise different aspects:

### If topic is about "onboarding" / "first-run" / "setup":
- Emphasise time-to-value, activation metrics, progressive profiling
...
- Emphasise wayfinding, discoverability, mental models
...
- Emphasise query patterns, faceted search, typeahead, result ranking
...
- Emphasise organization, discoverability, defaults, dangerous settings
...
- Emphasise notification fatigue, urgency levels, channel selection
...
- Emphasise first-time experience, calls to action, placeholder content
...
- Emphasise validation UX, inline errors, progressive forms, autosave
...
- Emphasise sorting, pagination vs. infinite scroll, bulk actions, column management
...
- Emphasise information hierarchy, actionable vs. informational, customization
...
- Emphasise comparison clarity, plan differentiation, upgrade paths
...
- Emphasise touch targets, thumb zones, progressive enhancement
...
- Emphasise readability, color contrast, image handling, user preference
...
- Emphasise error recovery, clear messaging, suggested actions
...
- Emphasise permissions, real-time presence, conflict resolution
